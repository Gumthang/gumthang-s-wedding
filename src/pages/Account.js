...
function ContactButton({ person, account, kakaopay }) {
  ...
  function Account() {
    const groom_contact = [
      { person: "신랑 이병환", account: "우리은행 1002-123-456789", kakaopay: "" },
      { person: "아버지 이동욱", account: "우리은행 0123456789", kakaopay: "" },
      { person: "어머니 강성일", account: "농협은행 0123456789", kakaopay: "" },
    ];

    const bride_contact = [
        { person: "신부 이성은", account: "신한은행 110-405-247948" , kakaopay: "" },
        { person: "아버지 이승우", account: "기업은행 0123456789", kakaopay: ""},
        { person: "어머니 안교란", account: "국민은행 0123456789", kakaopay: "" },
      ];
